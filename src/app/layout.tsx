      ...
      <body className={source.className}>
        <div className="grid grid-cols-12 p-4 gap-4">
          <div className="static col-span-12 sm:col-span-2">
            <div
              className={cn(
                "sm:fixed sm:top-0 sm:left-0 sm:w-2/12 w-full text-center flex flex-row sm:flex-col gap-4 justify-between items-center sm:justify-start sm:items-center",
                code.className
              )}
            >
              <Header />
